...
FROM (VALUES
    ('ВетПоиск "Здоровые Лапки"', 'Современная ветеринарная клиника с полным спектром услуг', 'ул. Пушкина, 15', '+7 (495) 123-45-67', 'info@healthypaws.ru', 'https://healthypaws.ru', 'Москва', 55.7558, 37.6176, '{"пн-пт": "9:00-21:00", "сб-вс": "10:00-18:00"}', 4.8, 0, true),
...
FROM (VALUES
    ('ВетПоиск "Здоровые Лапки"', 'Мария К.', 5, 'Отличная клиника! Врачи очень внимательные, быстро поставили диагноз моему коту. Цены адекватные.', true, 12, '2024-01-15 14:30:00'),
    ('ВетПоиск "Здоровые Лапки"', 'Александр П.', 4, 'Хорошее обслуживание, но долго ждали в очереди. В целом довольны результатом лечения.', true, 8, '2024-01-20 16:45:00'),
