...
BEGIN
    ...
    ('ВетКлиника "Северная"', 'Специализируемся на лечении экзотических животных и птиц. Круглосуточная помощь.', 'Невский пр., 78', '+7 (812) 345-67-89', 'help@north-vet.ru', 'https://north-vet.ru', spb_id, 59.9311, 30.3609, 4.7, 124, true, '{"monday": "00:00-23:59", "tuesday": "00:00-23:59", "wednesday": "00:00-23:59", "thursday": "00:00-23:59", "friday": "00:00-23:59", "saturday": "00:00-23:59", "sunday": "00:00-23:59"}'),
...
WHERE (c.name = 'ВетЦентр "Доктор Айболит"' AND p.full_name IN ('Иванова Елена Сергеевна', 'Петров Михаил Александрович'))
   ...
   OR (c.name = 'ВетКлиника "Северная"' AND p.full_name IN ('Козлов Дмитрий Игоревич', 'Морозова Ольга Петровна'))
...
FROM (VALUES
    ...
    ('ВетКлиника "Северная"', 'Козлов Дмитрий Игоревич', 'Елена В.', 'elena.v@email.ru', 'Специалист по экзотическим животным', 'Лечили попугая у доктора Козлова. Очень редко встретишь такого специалиста по птицам. Попугай здоров, спасибо!', 5, 6),
