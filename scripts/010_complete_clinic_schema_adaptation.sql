...
FROM (
  VALUES 
    ('ВетКлиника "Здоровый Питомец"', 'Современная ветеринарная клиника с полным спектром услуг', 'ул. Ленина, 15', '+7 (495) 123-45-67', 'info@healthypet.ru', 'Москва'),
    ...
    ('ВетКлиника "Друг"', 'Ваш надежный друг в заботе о питомцах', 'ул. Молодогвардейская, 34', '+7 (846) 222-33-44', 'friend@drug.samara.ru', 'Самара')
