// scripts/add_featured_functions.js
// Скрипт для добавления функций featured в базу данных Supabase
...
async function main() {
  ...
  const sqlContent = readFileSync('./scripts/020_add_featured_functions.sql', 'utf8');
