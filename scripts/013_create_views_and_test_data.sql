...
CROSS JOIN (
    VALUES 
    ('ВетПоиск "Доктор Айболит"', 'Современная ветеринарная клиника с полным спектром услуг', 'ул. Ветеринарная, 15', '+7 (495) 123-45-67', 'info@aibolit-vet.ru', 'https://aibolit-vet.ru', 55.7558, 37.6176, '{"пн-пт": "08:00-20:00", "сб": "09:00-18:00", "вс": "10:00-16:00"}', 4.8, 156),
